...
Phase 5 normalizes write actions into typed operations and removes legacy intent payloads from browser-facing flows.
...
`task test:network` verifies that write flows send typed operations and never legacy payloads.
