...
Phase 7 publishes runner logs as live events so the UI can show operation progress without polling only final state.
...
- Include correlation/job identifiers.
- Redact sensitive values.
- Preserve enough context for operator troubleshooting.
- Keep logs browser-safe for Simple Mode and Professional Mode.
