...
| Windows VS Code Development Configuration | docs/platform/windows-vscode-development.md | f60bc6f07a4d |
| Windows WSL2 Host Preflight | docs/platform/windows-wsl2-host-preflight.md | a56dbb0fcd27 |
| Windows WSL2 Ubuntu Bootstrap | docs/platform/windows-wsl2-ubuntu-bootstrap.md | 32b1fb2ac87c |
...
| Structurizr Architecture | docs/architecture/structurizr-architecture.md | 59ddc84119a4 |


## Android / Termux / ARM64 evidence

Tier 11 found 39 Android / Termux / ARM64-related evidence entries. Use the existing Android / Termux operations guide and smoke scripts where present; this generator only links and fingerprints existing sources.

## Ubuntu / WSL2 evidence

Tier 11 found 49 Ubuntu / WSL2-related evidence entries. Daily development and validation should run from the Linux filesystem repo, not from a Windows-mounted path.
