...
main() {
  ...
  local packages=(python nodejs wget unzip jq curl proot-distro caddy git mariadb openssl ncurses-utils util-linux ncurses coreutils moreutils termux-api ca-certificates gnupg tar gzip xz-utils shadow procps gitea golang)
  local p
